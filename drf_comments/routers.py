...
from drf_comments import views
from drf_comments.response import Response
from drf_comments.reverse import reverse
from drf_comments.schemas import SchemaGenerator
from drf_comments.schemas.views import SchemaView
...
class SimpleRouter(BaseRouter):
    ...
    def get_lookup_regex(self, viewset, lookup_prefix=''):
        ...
        Note that lookup_prefix is not used directly inside REST drf_comments
