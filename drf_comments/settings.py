...
DEFAULTS = {
    ...
    'DEFAULT_CONTENT_NEGOTIATION_CLASS': 'drf_comments.negotiation.DefaultContentNegotiation',
    ...
    # Schema
    'DEFAULT_SCHEMA_CLASS': 'drf_comments.schemas.openapi.AutoSchema',
    ...
    # View configuration
    'VIEW_NAME_FUNCTION': 'drf_comments.views.get_view_name',
    'VIEW_DESCRIPTION_FUNCTION': 'drf_comments.views.get_view_description',

    # Exception handling
    'EXCEPTION_HANDLER': 'drf_comments.views.exception_handler',
