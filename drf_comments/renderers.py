...
from drf_comments import VERSION, exceptions, serializers, status
from drf_comments.compat import (
    INDENT_SEPARATORS, LONG_SEPARATORS, SHORT_SEPARATORS, coreapi, coreschema,
    pygments_css, yaml
)
from drf_comments.exceptions import ParseError
from drf_comments.request import is_form_media_type, override_method
from drf_comments.settings import api_settings
from drf_comments.utils import encoders, json
from drf_comments.utils.breadcrumbs import get_breadcrumbs
from drf_comments.utils.field_mapping import ClassLookupDict
...
class HTMLFormRenderer(BaseRenderer):
    ...
    format = 'form'
    charset = 'utf-8'
    template_pack = 'drf_comments/vertical/'
...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    filter_template = 'drf_comments/filters/base.html'
    code_style = 'emacs'
    charset = 'utf-8'
    ...
    def render_form_for_serializer(self, serializer):
        ...
        return form_renderer.render(
            ...
            {'style': {'template_pack': 'drf_comments/horizontal'}}
        )
...
class DocumentationRenderer(BaseRenderer):
    ...
    format = 'html'
    charset = 'utf-8'
    template = 'drf_comments/docs/index.html'
    error_template = 'drf_comments/docs/error.html'
    code_style = 'emacs'
    ...
    def get_context(self, data, request):
        return {
            ...
            'lang_htmls': ["drf_comments/docs/langs/%s.html" % language for language in self.languages],
            'lang_intro_htmls': ["drf_comments/docs/langs/%s-intro.html" % language for language in self.languages],
            'code_style': pygments_css(self.code_style),
            'request': request
        }
...
class SchemaJSRenderer(BaseRenderer):
    ...
    format = 'javascript'
    charset = 'utf-8'
    template = 'drf_comments/schema.js'
