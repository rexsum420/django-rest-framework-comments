...
from drf_comments import RemovedInDRF317Warning
from drf_comments.compat import coreapi, coreschema
from drf_comments.exceptions import NotFound
...
class PageNumberPagination(BasePagination):
    ...
    template = 'drf_comments/pagination/numbers.html'
...
class CursorPagination(BasePagination):
    ...
    ordering = '-created'
    template = 'drf_comments/pagination/previous_and_next.html'
